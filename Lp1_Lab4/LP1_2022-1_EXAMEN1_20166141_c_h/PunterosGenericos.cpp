...
void cargaproductos( void *&productos){
    ...
    while (true) {
        ...
        if(nDatos==capacidad) incrementarProductos(registroProductos,nDatos,capacidad);
        registroProductos[nDatos-1]=registro;
        nDatos++;
    }
...
void cargapedidos(void *&pedidos){
    ...
    while (true) {
        ...
        if(nDatos==capacidad) incrementarPedidos(registroPedidos,nDatos,capacidad);
        registroPedidos[nDatos-1]=registro;
        nDatos++;
    }
...
void agregarPedido(void* &cliente,void *&pedido,int &nPedidosXCliente, int &nCapXCliente){
    //error esta aca
    //buscamos cliente en el pedido dado si coincide dni cliente y es pedido atendido
    ...
    if(nPedidosXCliente == nCapXCliente){ 
        incrementarPedidosXCliente(registroCliente[PRODUCTOCLIENTE],
                nPedidosXCliente,nCapXCliente);
        
    }
    void **producto=(void**)registroCliente[PRODUCTOCLIENTE];
    
    insertarPedido(producto[nPedidosXCliente-1],pedido);
...
void procesaclientes(void * &productos,void * &pedidos,void * &clientes){
    ...
    void **registroClientes,*registro,**registroPedido;
